...
class TransformerLanguageModel(FairseqLanguageModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument(
            "--share-decoder-parameters",
            default=False,
            action="store_true",
            help="share decoder parameters",
        )
        parser.add_argument(
            "--share-encoder-parameters",
            default=False,
            action="store_true",
        ...
        parser.add_argument(
            "--share-encoder-parameters-last",
            default=False,
            action="store_true",
            help="share encoder parameters",
        )
        parser.add_argument(
            "--share-decoder-parameters-last",
            default=False,
            action="store_true",
            help="share encoder parameters",
        )
        ...
        parser.add_argument(
            "--share-encoder-parameters-sandwich",
            default=False,
            action="store_true",
            help="share encoder parameters",
        )
        parser.add_argument(
            "--share-decoder-parameters-sandwich",
            default=False,
            action="store_true",
            help="share encoder parameters",
        )
        parser.add_argument(
            "--reduction-dim", type=int, metavar="N", help="reduction_dim"
        )
        parser.add_argument(
            "--add-independent-layer",
            default=False,
            action="store_true",
        ...
        parser.add_argument(
            "--sandwich-ffn-embed-dim",
            type=int,
            metavar="N",
            help="sandwich embedding dimension for FFN",
        )
        parser.add_argument(
            "--sandwich-layers", type=int, metavar="N", help="num sandwich layers"
        )
        parser.add_argument(
            "--sandwich-attention-heads",
            type=int,
            metavar="N",
...
def base_lm_architecture(args):
    ...
    args.sandwich_embed_dim = getattr(args, "sandwich_embed_dim", 512)
    args.sandwich_ffn_embed_dim = getattr(args, "sandwich_ffn_embed_dim", 2048)
